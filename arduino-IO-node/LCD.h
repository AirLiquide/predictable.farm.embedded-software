/******************************************************************************
  LCD.h - LCD library Version 1.22
...
#define     LCD_TRANS_ONCE_BYTE_MAX      (6)


/**************************************************************
      Defines for I2C driver APIs.
      NOTE:
      1. If you want to use LCD on other MCUs or platforms, please change the I2C driver APIs show below.
      2. You also can redefine these five functions at the begin of LCD.c.
         Init()
         ReadByteFromReg()
         WriteByteToReg()
         ReadSeriesFromReg()
